...
const moviesAPIController = {
    page:(req,res)=>{
        switch (true) {
            case req.originalUrl == '/create':
                res.render('formulario')
                break;
            case req.originalUrl == '/favoritas':
                res.render('favoritas')
                break;
            default:
                res.send("Hubo un error: "+ req.originalUrl)
                break;
        }
    },
    list: (req, res) => {
